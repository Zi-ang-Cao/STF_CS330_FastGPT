...
class LMEnv(gym.Env):
    ...
    random_seed:int=42, obs_dim:int = 10):
        ...
        self.writer = SummaryWriter(f"CS330_FastGPT_{model_name}_{env_device}/{algorithm}/NEW_Action_MLogits")
...
if algorithm=="PPO":
    ...
    model.learn(total_timesteps=2E5, tb_log_name=f"{algorithm}/new_ActionSpace_MLogits")
