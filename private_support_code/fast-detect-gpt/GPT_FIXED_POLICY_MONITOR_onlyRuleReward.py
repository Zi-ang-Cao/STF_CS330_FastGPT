...
if algorithm=="PPO":
    ...
    # model.learn(total_timesteps=6E5, tb_log_name=f"{algorithm}/fixedACT_MONITOR_onlyRuleReward", 
    model.learn(total_timesteps=6E6, tb_log_name=f"{algorithm}/fixedACT_MONITOR_onlyRuleReward", 
