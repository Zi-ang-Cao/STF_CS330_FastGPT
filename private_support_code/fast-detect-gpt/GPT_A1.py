...
class LMEnv(gym.Env):
    ...
    def _load_datasets(self):
        ...
        if self.dataset == "xsum":
            ...
            start_idx = self.args.overfit_sentence_idx
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ruleBasedPenalty", default=True, type=bool)
    parser.add_argument("--InStepScore", default=True, type=bool)
    parser.add_argument("--InStepPerturbCost", default=True, type=bool)
    ...
    args.RL_model_name = f"S_{args.overfit_sentence_idx}_{reward_describe}_{timestamp}"
    ...
    vec_env = init_env_for_agent_training(args, n_envs=1)
