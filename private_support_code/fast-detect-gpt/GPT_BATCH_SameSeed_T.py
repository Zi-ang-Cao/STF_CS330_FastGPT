...
sameSeed = True
N_topK = 10  # 10 -- default

# Tensorboard log names
RL_model_name = f"fixedACT_BATCH_{n_envs}_N_topK_{N_topK}_sameSeed_{sameSeed}"
...
class LMEnv(gym.Env):
    ...
    def __init__(self, sampling_mode: str = "argmax", topK_logistics: int=N_topK, dataset: str="xsum", n_train:int = 1, 
...
if __name__ == "__main__":
    ...
    if algorithm=="PPO":
        ...
        model.learn(total_timesteps=2E5, tb_log_name=f"{algorithm}/{RL_model_name}", 
